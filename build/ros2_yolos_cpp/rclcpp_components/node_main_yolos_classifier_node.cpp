...
#define NODE_MAIN_LOGGER_NAME "yolos_classifier_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libros2_yolos_cpp_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ros2_yolos_cpp::YolosClassifierNode>";
