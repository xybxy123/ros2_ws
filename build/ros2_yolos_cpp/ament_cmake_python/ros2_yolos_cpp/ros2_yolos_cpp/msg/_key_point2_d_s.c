...
bool ros2_yolos_cpp__msg__key_point2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_yolos_cpp.msg._key_point2_d.KeyPoint2D", full_classname_dest, 43) == 0);
  }
  ros2_yolos_cpp__msg__KeyPoint2D * ros_message = _ros_message;
  {  // x
...
PyObject * ros2_yolos_cpp__msg__key_point2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_yolos_cpp.msg._key_point2_d");
