...
bool ros2_yolos_cpp__msg__obb_detection2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_yolos_cpp.msg._obb_detection2_d.OBBDetection2D", full_classname_dest, 51) == 0);
  }
  ros2_yolos_cpp__msg__OBBDetection2D * ros_message = _ros_message;
  {  // header
  ...
  {  // bbox
    ...
    if (!ros2_yolos_cpp__msg__oriented_bounding_box2_d__convert_from_py(field, &ros_message->bbox)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of OBBDetection2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_yolos_cpp.msg._obb_detection2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OBBDetection2D");
  ...
  {  // bbox
    PyObject * field = NULL;
    field = ros2_yolos_cpp__msg__oriented_bounding_box2_d__convert_to_py(&ros_message->bbox);
    if (!field) {
      return NULL;
    }
    {
