...
static const _KeyPoint2DArray_type_support_symbol_names_t _KeyPoint2DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_yolos_cpp, msg, KeyPoint2DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_yolos_cpp, msg, KeyPoint2DArray)),
  }
};
...
{
  return &::ros2_yolos_cpp::msg::rosidl_typesupport_cpp::KeyPoint2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_yolos_cpp, msg, KeyPoint2DArray)() {
  return get_message_type_support_handle<ros2_yolos_cpp::msg::KeyPoint2DArray>();
}
