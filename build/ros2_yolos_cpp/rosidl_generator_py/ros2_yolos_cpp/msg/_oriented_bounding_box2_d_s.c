...
bool ros2_yolos_cpp__msg__oriented_bounding_box2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_yolos_cpp.msg._oriented_bounding_box2_d.OrientedBoundingBox2D", full_classname_dest, 66) == 0);
  }
  ros2_yolos_cpp__msg__OrientedBoundingBox2D * ros_message = _ros_message;
  {  // center
...
{
  /* NOTE(esteve): Call constructor of OrientedBoundingBox2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_yolos_cpp.msg._oriented_bounding_box2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OrientedBoundingBox2D");
