...
static char ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__header[] = "header";
static char ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__bbox[] = "bbox";
static char ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__class_id[] = "class_id";
static char ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__class_name[] = "class_name";
static char ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__score[] = "score";

static rosidl_runtime_c__type_description__Field ros2_yolos_cpp__msg__OBBDetection2D__FIELDS[] = {
  {
    {ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__bbox, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__class_id, 8, 8},
    {
  ...
  {
    {ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__class_name, 10, 10},
    {
  ...
  {
    {ros2_yolos_cpp__msg__OBBDetection2D__FIELD_NAME__score, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ros2_yolos_cpp__msg__OBBDetection2D__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ros2_yolos_cpp__msg__OBBDetection2D__FIELDS, 5, 5},
    },
    {ros2_yolos_cpp__msg__OBBDetection2D__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[2].fields = ros2_yolos_cpp__msg__OrientedBoundingBox2D__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  ...
  "ros2_yolos_cpp/OrientedBoundingBox2D bbox\n"
  "\n"
  "# Class ID\n"
  "int32 class_id\n"
  "\n"
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ros2_yolos_cpp__msg__OBBDetection2D__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[3] = *ros2_yolos_cpp__msg__OrientedBoundingBox2D__get_individual_type_description_source(NULL);
