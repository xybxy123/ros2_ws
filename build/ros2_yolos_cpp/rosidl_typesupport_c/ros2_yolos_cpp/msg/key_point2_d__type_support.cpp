...
static const _KeyPoint2D_type_support_symbol_names_t _KeyPoint2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_yolos_cpp, msg, KeyPoint2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_yolos_cpp, msg, KeyPoint2D)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_yolos_cpp, msg, KeyPoint2D)() {
  return &::ros2_yolos_cpp::msg::rosidl_typesupport_c::KeyPoint2D_message_type_support_handle;
}
