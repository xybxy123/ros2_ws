...
static const _KeyPoint2DArray_type_support_symbol_names_t _KeyPoint2DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_yolos_cpp, msg, KeyPoint2DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_yolos_cpp, msg, KeyPoint2DArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_yolos_cpp, msg, KeyPoint2DArray)() {
  return &::ros2_yolos_cpp::msg::rosidl_typesupport_c::KeyPoint2DArray_message_type_support_handle;
}
