...
enum
{
  slam_toolbox__srv__AddSubmap_Event__request__MAX_SIZE = 1
};
// response
enum
{
  slam_toolbox__srv__AddSubmap_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/AddSubmap in the package slam_toolbox.
typedef struct slam_toolbox__srv__AddSubmap_Event
{
  service_msgs__msg__ServiceEventInfo info;
  slam_toolbox__srv__AddSubmap_Request__Sequence request;
  slam_toolbox__srv__AddSubmap_Response__Sequence response;
} slam_toolbox__srv__AddSubmap_Event;

// Struct for a sequence of slam_toolbox__srv__AddSubmap_Event.
typedef struct slam_toolbox__srv__AddSubmap_Event__Sequence
{
