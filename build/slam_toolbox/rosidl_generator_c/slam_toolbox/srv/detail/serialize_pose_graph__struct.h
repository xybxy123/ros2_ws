...
enum
{
  slam_toolbox__srv__SerializePoseGraph_Response__RESULT_SUCCESS = 0
};

/// Constant 'RESULT_FAILED_TO_WRITE_FILE'.
enum
{
  slam_toolbox__srv__SerializePoseGraph_Response__RESULT_FAILED_TO_WRITE_FILE = 255
};
...
enum
{
  slam_toolbox__srv__SerializePoseGraph_Event__request__MAX_SIZE = 1
};
// response
enum
{
  slam_toolbox__srv__SerializePoseGraph_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SerializePoseGraph in the package slam_toolbox.
typedef struct slam_toolbox__srv__SerializePoseGraph_Event
{
  service_msgs__msg__ServiceEventInfo info;
  slam_toolbox__srv__SerializePoseGraph_Request__Sequence request;
  slam_toolbox__srv__SerializePoseGraph_Response__Sequence response;
} slam_toolbox__srv__SerializePoseGraph_Event;

// Struct for a sequence of slam_toolbox__srv__SerializePoseGraph_Event.
typedef struct slam_toolbox__srv__SerializePoseGraph_Event__Sequence
{
