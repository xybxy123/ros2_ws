...
class Metaclass_MergeMaps_Event(type):
    """Metaclass of message 'MergeMaps_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__merge_maps__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__merge_maps__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__merge_maps__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__merge_maps__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__merge_maps__event
...
class MergeMaps_Event(metaclass=Metaclass_MergeMaps_Event):
    """Message class 'MergeMaps_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<slam_toolbox/MergeMaps_Request, 1>',
        'response': 'sequence<slam_toolbox/MergeMaps_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'srv'], 'MergeMaps_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'srv'], 'MergeMaps_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from slam_toolbox.srv import MergeMaps_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, MergeMaps_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MergeMaps_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from slam_toolbox.srv import MergeMaps_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MergeMaps_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MergeMaps_Response'"
...
class Metaclass_MergeMaps(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _merge_maps.Metaclass_MergeMaps_Event._TYPE_SUPPORT is None:
                _merge_maps.Metaclass_MergeMaps_Event.__import_type_support__()
...
class MergeMaps(metaclass=Metaclass_MergeMaps):
    ...
    from slam_toolbox.srv._merge_maps import MergeMaps_Event as Event
