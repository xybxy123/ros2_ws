...
class Metaclass_SerializePoseGraph_Response(type):
    ...
    __constants = {
        'RESULT_SUCCESS': 0,
        'RESULT_FAILED_TO_WRITE_FILE': 255,
    }
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'RESULT_FAILED_TO_WRITE_FILE': cls.__constants['RESULT_FAILED_TO_WRITE_FILE'],
        }

    @property
    def RESULT_SUCCESS(self):
        """Message constant 'RESULT_SUCCESS'."""
        return Metaclass_SerializePoseGraph_Response.__constants['RESULT_SUCCESS']

    @property
    def RESULT_FAILED_TO_WRITE_FILE(self):
        """Message constant 'RESULT_FAILED_TO_WRITE_FILE'."""
        return Metaclass_SerializePoseGraph_Response.__constants['RESULT_FAILED_TO_WRITE_FILE']
...
class Metaclass_SerializePoseGraph_Event(type):
    """Metaclass of message 'SerializePoseGraph_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__serialize_pose_graph__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__serialize_pose_graph__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__serialize_pose_graph__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__serialize_pose_graph__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__serialize_pose_graph__event
...
class SerializePoseGraph_Event(metaclass=Metaclass_SerializePoseGraph_Event):
    """Message class 'SerializePoseGraph_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<slam_toolbox/SerializePoseGraph_Request, 1>',
        'response': 'sequence<slam_toolbox/SerializePoseGraph_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'srv'], 'SerializePoseGraph_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'srv'], 'SerializePoseGraph_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from slam_toolbox.srv import SerializePoseGraph_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SerializePoseGraph_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SerializePoseGraph_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from slam_toolbox.srv import SerializePoseGraph_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SerializePoseGraph_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SerializePoseGraph_Response'"
...
class Metaclass_SerializePoseGraph(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _serialize_pose_graph.Metaclass_SerializePoseGraph_Event._TYPE_SUPPORT is None:
                _serialize_pose_graph.Metaclass_SerializePoseGraph_Event.__import_type_support__()
...
class SerializePoseGraph(metaclass=Metaclass_SerializePoseGraph):
    ...
    from slam_toolbox.srv._serialize_pose_graph import SerializePoseGraph_Event as Event
