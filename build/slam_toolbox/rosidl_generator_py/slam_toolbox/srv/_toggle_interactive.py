...
class Metaclass_ToggleInteractive_Event(type):
    """Metaclass of message 'ToggleInteractive_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__toggle_interactive__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__toggle_interactive__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__toggle_interactive__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__toggle_interactive__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__toggle_interactive__event
...
class ToggleInteractive_Event(metaclass=Metaclass_ToggleInteractive_Event):
    """Message class 'ToggleInteractive_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<slam_toolbox/ToggleInteractive_Request, 1>',
        'response': 'sequence<slam_toolbox/ToggleInteractive_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'srv'], 'ToggleInteractive_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'srv'], 'ToggleInteractive_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from slam_toolbox.srv import ToggleInteractive_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ToggleInteractive_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ToggleInteractive_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from slam_toolbox.srv import ToggleInteractive_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ToggleInteractive_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ToggleInteractive_Response'"
...
class Metaclass_ToggleInteractive(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _toggle_interactive.Metaclass_ToggleInteractive_Event._TYPE_SUPPORT is None:
                _toggle_interactive.Metaclass_ToggleInteractive_Event.__import_type_support__()
...
class ToggleInteractive(metaclass=Metaclass_ToggleInteractive):
    ...
    from slam_toolbox.srv._toggle_interactive import ToggleInteractive_Event as Event
