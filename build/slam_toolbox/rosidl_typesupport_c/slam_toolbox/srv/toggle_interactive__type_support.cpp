...
static const _ToggleInteractive_Event_type_support_symbol_names_t _ToggleInteractive_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, srv, ToggleInteractive_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_toolbox, srv, ToggleInteractive_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_toolbox, srv, ToggleInteractive_Event)() {
  return &::slam_toolbox::srv::rosidl_typesupport_c::ToggleInteractive_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ToggleInteractive_service_type_support_handle = {
  ...
  &ToggleInteractive_Request_message_type_support_handle,
  &ToggleInteractive_Response_message_type_support_handle,
  &ToggleInteractive_Event_message_type_support_handle,
