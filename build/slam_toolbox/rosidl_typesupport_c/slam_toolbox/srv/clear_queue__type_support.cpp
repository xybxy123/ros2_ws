...
static const _ClearQueue_Event_type_support_symbol_names_t _ClearQueue_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, srv, ClearQueue_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_toolbox, srv, ClearQueue_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_toolbox, srv, ClearQueue_Event)() {
  return &::slam_toolbox::srv::rosidl_typesupport_c::ClearQueue_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ClearQueue_service_type_support_handle = {
  ...
  &ClearQueue_Request_message_type_support_handle,
  &ClearQueue_Response_message_type_support_handle,
  &ClearQueue_Event_message_type_support_handle,
