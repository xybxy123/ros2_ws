...
static const _Clear_Event_type_support_symbol_names_t _Clear_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, srv, Clear_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_toolbox, srv, Clear_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_toolbox, srv, Clear_Event)() {
  return &::slam_toolbox::srv::rosidl_typesupport_c::Clear_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Clear_service_type_support_handle = {
  ...
  &Clear_Request_message_type_support_handle,
  &Clear_Response_message_type_support_handle,
  &Clear_Event_message_type_support_handle,
