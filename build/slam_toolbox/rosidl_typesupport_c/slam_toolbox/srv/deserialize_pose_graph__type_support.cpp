...
static const _DeserializePoseGraph_Event_type_support_symbol_names_t _DeserializePoseGraph_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, srv, DeserializePoseGraph_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_toolbox, srv, DeserializePoseGraph_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_toolbox, srv, DeserializePoseGraph_Event)() {
  return &::slam_toolbox::srv::rosidl_typesupport_c::DeserializePoseGraph_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t DeserializePoseGraph_service_type_support_handle = {
  ...
  &DeserializePoseGraph_Request_message_type_support_handle,
  &DeserializePoseGraph_Response_message_type_support_handle,
  &DeserializePoseGraph_Event_message_type_support_handle,
