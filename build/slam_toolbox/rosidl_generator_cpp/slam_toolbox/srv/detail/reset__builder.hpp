...
{
public:
  explicit Init_Reset_Event_response(::slam_toolbox::srv::Reset_Event & msg)
  : msg_(msg)
  {}
  ::slam_toolbox::srv::Reset_Event response(::slam_toolbox::srv::Reset_Event::_response_type arg)
  {
...
private:
  ::slam_toolbox::srv::Reset_Event msg_;
};

class Init_Reset_Event_request
{
public:
  explicit Init_Reset_Event_request(::slam_toolbox::srv::Reset_Event & msg)
  : msg_(msg)
  {}
  Init_Reset_Event_response request(::slam_toolbox::srv::Reset_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Reset_Event_request info(::slam_toolbox::srv::Reset_Event::_info_type arg)
  {
...
template<>
inline
auto build<::slam_toolbox::srv::Reset_Event>()
{
  return slam_toolbox::srv::builder::Init_Reset_Event_info();
}
