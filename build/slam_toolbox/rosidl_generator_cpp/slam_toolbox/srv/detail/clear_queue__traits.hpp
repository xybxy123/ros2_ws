...
inline std::string to_yaml(const ClearQueue_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use slam_toolbox::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const slam_toolbox::srv::ClearQueue_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  slam_toolbox::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use slam_toolbox::srv::to_yaml() instead")]]
inline std::string to_yaml(const slam_toolbox::srv::ClearQueue_Event & msg)
{
  return slam_toolbox::srv::to_yaml(msg);
}

template<>
inline const char * data_type<slam_toolbox::srv::ClearQueue_Event>()
{
  return "slam_toolbox::srv::ClearQueue_Event";
}

template<>
inline const char * name<slam_toolbox::srv::ClearQueue_Event>()
{
  return "slam_toolbox/srv/ClearQueue_Event";
}

template<>
struct has_fixed_size<slam_toolbox::srv::ClearQueue_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<slam_toolbox::srv::ClearQueue_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<slam_toolbox::srv::ClearQueue_Request>::value && has_bounded_size<slam_toolbox::srv::ClearQueue_Response>::value> {};

template<>
struct is_message<slam_toolbox::srv::ClearQueue_Event>
  : std::true_type {};
