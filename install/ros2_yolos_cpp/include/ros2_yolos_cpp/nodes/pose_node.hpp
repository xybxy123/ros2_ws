...
#ifndef ROS2_YOLOS_CPP__NODES__POSE_NODE_HPP_
#define ROS2_YOLOS_CPP__NODES__POSE_NODE_HPP_
...
class ROS2_YOLOS_CPP_PUBLIC YolosPoseNode : public rclcpp_lifecycle::LifecycleNode {
public:
  explicit YolosPoseNode(const rclcpp::NodeOptions& o);
...
private:
  ...
  std::unique_ptr<IPoseAdapter> pose_;
